...
test('DeepL link translates one German definition into English', () => {
  ...
  assert.equal(
    deeplTranslationUrl('zum prüfenden/beurteilenden Betrachten'),
    'https://www.deepl.com/translator#de/en/zum%20pr%C3%BCfenden%EF%BC%8Fbeurteilenden%20Betrachten',
  );
